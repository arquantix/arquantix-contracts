...
/**
 * @title LegacyStakingTransition
 * @notice This contract is used to transition from the legacy staking contract to the new one.
 *
 * @author vBlackwhale (https://github.com/vblackwhale)
 */
contract LegacyStakingTransition is
  BaseUpgradeable,
