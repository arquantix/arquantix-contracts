 ...
 * @notice Interface for the GlobalBlacklist contract that holds a global mapping of 
 * blacklisted accounts shared by all contracts of the Ledgity Yield codebase.
 */
